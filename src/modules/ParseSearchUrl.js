  ...
  try {
    ...
    if (hasQM && removeParameters) {
      queryString = queryString
        .split("&")
        .filter((part) => searchTerms.every((term) => part.indexOf(term) >= 0))
        .join("&");
    }
